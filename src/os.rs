...
pub fn read_osname() -> String {
    let output = System::long_os_version().unwrap_or_else(|| "Unknown".to_string());
...
pub fn read_hostname() -> String {
    let output = System::host_name().unwrap_or_else(|| "Unknown".to_string());
...
pub fn read_kernel() -> String {
    let output = System::kernel_version().unwrap_or_else(|| "Unknown".to_string());
